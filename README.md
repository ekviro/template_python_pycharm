...
Установить python x64 (язык + интерпретатор + стандартные инструменты). В него уже входит venv (инструмент для создания виртуального окружения) и pip (менеджер пакетов Python для установки библиотек).
